...
public class LinkedStack<E> implements Cloneable
{
   ...
   **/ 
   ...
   /**
   * Returns item at a certain position in the stack.
   * @param - position
   *   how far down the stack to return
   * <dt><b>Precondition:</b><dd>
   *   This stack is not empty.
   * @return
   *   the position item of the stack
   * @exception EmptyStackException
   *   Indicates that this stack is empty.
   **/   
   public E itemAt(int position)   
   {
      if (top == null)
         // EmptyStackException is from java.util and its constructor has no argument.
         throw new EmptyStackException( );
      Node<E> reqItem;   
      reqItem = top.listPosition(top, position); //position 1 = the top of the stack 
      return reqItem.getData();
   }
