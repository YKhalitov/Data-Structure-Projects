...
// Class: CSC 103
// Description: This table works with double hashing
...
public class TableDoubleHash< K , E >
{
   ...
   **/
   ...
   // The return value is a valid index of the table arrays. The index is
   // calculated as the remainder when the absolute value of the key
   // hash code is divided by the size of the table arrays subtracted by 2
   // and the total added by 1.
   {
